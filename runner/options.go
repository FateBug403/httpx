...
import (
	...
	"github.com/FateBug403/httpx/common/customheader"
	"github.com/FateBug403/httpx/common/customlist"
...
type Options struct {
	OutputMethod              bool // 请求方法，默认探测
	ExtractTitle              bool // 标题,默认探测
	StatusCode                bool // 状态码，默认探测
	OutputContentType         bool // 返回类型，默认探测
	OutputResponseTime        bool // 响应时间，默认探测
	OutputLinesCount          bool // 响应单词数，默认探测
	OutputWordsCount          bool // 响应行数，默认探测
	OutputIP                  bool // ip地址，默认探测
	OutputCName               bool // cname地址，默认探测
	ContentLength             bool // 响应body长度
	Location                  bool // 重定向位置
	Favicon                   bool // 网站图标
	Jarm                      bool // jarm指纹，标识网站
	OutputServerHeader        bool // 响应header头
	TechDetect                bool // 网站指纹探测
	OutputWebSocket           bool
	Asn                       bool
	OutputCDN                 bool
	Probe                     bool
	Hashes                    string
	CustomHeaders             customheader.CustomHeaders // 自定义header头
	CustomPorts               customport.CustomPorts // 自定义端口
	matchStatusCode           []int
	...
	HTTPProxy                 string
	SocksProxy                string
	InputFile                 []string // 批量检测目标
	InputTargetHost           goflags.StringSlice
	Methods                   string // 请求方法探测，使用'all'探测所有HTTP方法
	RequestURI                string
	RequestURIs               string
	requestURIs               []string
	...
	Screenshot                bool // 截图
	UseInstalledChrome        bool
	Ctx 					  context.Context //用来停止程序运行
}

//Serialize 注册自定义类型的序列化函数
...
//Deserialize 注册自定义类型的反序列化函数
func (o *Options) Deserialize(s string) error {
...
var DefaultOptions = &Options{
	...
	StatusCode:false,
	ContentLength:false,
	OutputContentType:false,
	Location:true,
	Favicon:true,
	Hashes:"",
	Jarm:true,
	OutputResponseTime:false,
	...
	// 其他
	//CustomPorts:[]string{"21","80","81","82","443","888","2181","2379","2375","3000","4502","4822","4848","4999","5000","5003","5601","5672","5984","6006","6080","6443","6984","7000","7001","7002","7010","7100","7547","7700","7777","7801","8000","8001","8002","8003","8005","8009","8010","8011","8060","8069","8070","8080","8081","8082","8083","8085","8086","8087","8088","8089","8090","8091","8161","8443","8848","8880","8888","8970","8989","9000","9001","9002","9043","9080","9090","9092","9200","9300","9443","9898","9900","9998","9999","10000","10002","10051","18083","50000","50070","61616"},
}



// ParseOptions 为应用程序解析命令行选项
func ParseOptions() *Options {
	...
	flagSet.CreateGroup("configs", "Configurations",
		...
		flagSet.StringVar(&options.Methods, "x", "", "请求方法探测，使用'all'探测所有HTTP方法"),
